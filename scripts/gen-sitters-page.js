...
chunk = chunk
  ...
  .replace(/from-green-400 via-emerald-500 to-teal-600/g, "from-pink-400 via-rose-400 to-pink-600")
  .replace(/from-emerald-50/g, "from-pink-100 via-pink-50")
  .replace(/from-green-600 to-emerald-600/g, "from-pink-500 to-rose-500")
  .replace(/from-green-100 to-emerald-100/g, "from-pink-100 to-rose-100")
  .replace(/border-green-/g, "border-pink-")
  .replace(/bg-green-/g, "bg-pink-")
  .replace(/text-green-/g, "text-pink-")
  .replace(/hover:bg-green-/g, "hover:bg-pink-")
  .replace(/focus:border-green-/g, "focus:border-pink-")
